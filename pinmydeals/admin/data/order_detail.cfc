<cfcomponent extends="core.pages.page">
	...
	<cffunction name="processFormDataAfterValidation" access="public" output="false" returnType="struct">
		...
		<cfif StructKeyExists(FORM,"save_order_status")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlAdmin##getPageName()#.cfm?id=#LOCAL.order.getOrderId()#" />
		...
		<cfelseif StructKeyExists(FORM,"save_product_status")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlAdmin##getPageName()#.cfm?id=#LOCAL.order.getOrderId()#&active_tab_id=tab_3" />	
		...
		<cfelseif StructKeyExists(FORM,"save_product_tracking_number")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlAdmin##getPageName()#.cfm?id=#LOCAL.order.getOrderId()#&active_tab_id=tab_2" />		
