<cfcomponent extends="core.pages.page">
	...
	<cffunction name="processFormDataAfterValidation" access="public" output="false" returnType="struct">
		...
		<cfif StructKeyExists(FORM,"id")>
				...
				<cfloop collection="#FORM#" item="LOCAL.key">
					<cfif Find("UPLOADER_",LOCAL.key) AND Find("_STATUS",LOCAL.key)>
						...
						<cfif StructFind(FORM,LOCAL.key) EQ "done">
							...
							<cfset LOCAL.imagePath = ExpandPath("#APPLICATION.urlHttpsAdmin#images/uploads/product/") />
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlHttpsAdmin##getPageName()#.cfm?id=#LOCAL.product.getProductId()#&active_tab_id=#LOCAL.tab_id#" />
		...
		<cfelseif StructKeyExists(FORM,"delete_item")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlHttpsAdmin#products.cfm" />
		...
		<cfelseif StructKeyExists(FORM,"delete_image")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlHttpsAdmin##getPageName()#.cfm?id=#LOCAL.product.getProductId()#&active_tab_id=tab_4" />	
		...
		<cfelseif StructKeyExists(FORM,"add_new_video")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlHttpsAdmin##getPageName()#.cfm?id=#LOCAL.product.getProductId()#&active_tab_id=tab_9" />
		...
		<cfelseif StructKeyExists(FORM,"delete_attribute_option_value")>
			...
			<cfset LOCAL.redirectUrl = "#APPLICATION.urlHttpsAdmin##getPageName()#.cfm?id=#FORM.id#&active_tab_id=tab_5" />
		</cfif>
