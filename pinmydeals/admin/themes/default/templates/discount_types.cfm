		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					...
					<a href="#APPLICATION.absoluteUrlSite#discount_type_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New Discount Type</a>
				</div><!-- /.box-header -->
						...
						<cfif ArrayLen(REQUEST.pageData.discountTypes) GT 0>
							<cfloop array="#REQUEST.pageData.discountTypes#" index="type">
								<tr>
									...
									<td><a href="#APPLICATION.absoluteUrlSite#discount_type_detail.cfm?id=#type.getDiscountTypeId()#">View Detail</a></td>
								</tr>
							</cfloop>
						<cfelse>
							<tr>
