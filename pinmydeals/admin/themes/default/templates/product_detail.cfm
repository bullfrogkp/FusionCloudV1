...
<script>
	$(document).ready(function() {
		...
		$("##uploader").plupload({
			...
			url: "#APPLICATION.urlHttpsAdmin#ajax/upload_product_images.cfm",
		...
		$( "##add-new-attribute-option-confirm" ).click(function() {
			...
			option.imageSrc = '#APPLICATION.urlHttpsAdmin#images/site/no_image_available.png';
											...
											<div class="col-xs-2">
												<div class="box box-warning">
													<div class="box-body table-responsive no-padding">
														<table class="table table-hover">
															<tr class="warning">
																<th><img src="#APPLICATION.urlHttpsAdmin#images/uploads/shipping/#sc.getImageName()#" style="height:25px;vertical-align:top;" /></th>
