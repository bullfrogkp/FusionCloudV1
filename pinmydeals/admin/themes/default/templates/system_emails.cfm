		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					...
					<a href="#APPLICATION.absoluteUrlSite#system_email_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New System Email</a>
				</div><!-- /.box-header -->
					...
					<table class="table table-bordered table-hover">
						...
						<cfif ArrayLen(REQUEST.pageData.paginationInfo.records) NEQ 0>
							...
							<tr>
								...
								<td><a href="#APPLICATION.absoluteUrlSite#system_email_detail.cfm?id=#systemEmail.getSystemEmailId()#">View Detail</a></td>
							</tr>
							</cfloop>
						<cfelse>
							<tr>
