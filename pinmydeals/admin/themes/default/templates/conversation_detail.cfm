				...
				<div class="box-body">
					<cfif IsNumeric(REQUEST.pageData.formData.id)>
						<div class="form-group">
							<label>Customer <a href="#APPLICATION.absoluteUrlSite#admin/customer_detail.cfm?id=#REQUEST.pageData.conversation.getCustomer().getCustomerId()#" class="form-link" style="margin-left:18px;">#REQUEST.pageData.conversation.getCustomer().getFullName()#</a></label>
						</div>
						<div class="form-group">
