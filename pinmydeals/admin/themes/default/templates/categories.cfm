	 ...
	 <div class="row">
				...
				<div class="box-body">
					<ul>
						<cfloop array="#REQUEST.pageData.categoryTree#" index="cat">
							<li><a href="#APPLICATION.absoluteUrlSite#admin/category_detail.cfm?id=#cat.getCategoryId()#">#cat.getDisplayName()#</a>
							<cfif ArrayLen(cat.getSubCategories()) NEQ 0>
								<ul>
							</cfif>
							<cfloop array="#cat.getSubCategories()#" index="subCat">
								<li><a href="#APPLICATION.absoluteUrlSite#admin/category_detail.cfm?id=#subCat.getCategoryId()#">#subCat.getDisplayName()#</a>
								<cfif ArrayLen(subCat.getSubCategories()) NEQ 0>
									<ul>
								</cfif>
								<cfloop array="#subCat.getSubCategories()#" index="thirdCat">
									<li><a href="#APPLICATION.absoluteUrlSite#admin/category_detail.cfm?id=#thirdCat.getCategoryId()#">#thirdCat.getDisplayName()#</a>
								</cfloop>
								<cfif ArrayLen(subCat.getSubCategories()) NEQ 0>
									</ul>
								</cfif>
		...
		<div class="col-md-8">
			...
			<div class="box box-warning">
				<div class="box-header">
					<h3 class="box-title">Categories</h3>
					<a href="#APPLICATION.absoluteUrlSite#admin/category_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New Category</a>
				</div><!-- /.box-header -->
					...
					<table class="table table-bordered table-hover">
						...
						<cfif ArrayLen(REQUEST.pageData.paginationInfo.records) NEQ 0>
							...
							<tr>
								...
								<td><a href="#APPLICATION.absoluteUrlSite#admin/category_detail.cfm?id=#category.getCategoryId()#">View Detail</a></td>
							</tr>
							</cfloop>
						<cfelse>
							<tr>
