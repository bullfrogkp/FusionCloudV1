		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					...
					<a href="#APPLICATION.absoluteUrlSite#admin/product_group_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New Product Group</a>
				</div><!-- /.box-header -->
					...
					<table class="table table-bordered table-hover">
							...
							<cfif ArrayLen(REQUEST.pageData.productGroups) GT 0>
								...
								<tr>
									...
									<td><a href="#APPLICATION.absoluteUrlSite#admin/product_group_detail.cfm?id=#group.getProductGroupId()#">View Detail</a></td>
								</tr>
								</cfloop>
							<cfelse>
								<tr>
