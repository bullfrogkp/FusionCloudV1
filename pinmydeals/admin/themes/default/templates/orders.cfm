		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					...
					<a href="#APPLICATION.absoluteUrlSite#new_order.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New Order</a>
				</div><!-- /.box-header -->
						...
						<cfif ArrayLen(REQUEST.pageData.paginationInfo.records) NEQ 0>
							<cfloop array="#REQUEST.pageData.paginationInfo.records#" index="order">
								<tr>
									...
									<td><a href="#APPLICATION.absoluteUrlSite#order_detail.cfm?id=#order.getOrderId()#&active_tab_id=tab_4">Invoice</a></td>
