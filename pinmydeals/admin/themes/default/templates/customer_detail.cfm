	...
	<div class="row">
		...
		<div class="col-md-12">
							...
							<cfif NOT IsNull(REQUEST.pageData.customer) AND NOT IsNull(REQUEST.pageData.customer.getOrders()) AND ArrayLen(REQUEST.pageData.customer.getOrders()) GT 0>
								<cfloop array="#REQUEST.pageData.customer.getOrders()#" index="order">
									<tr>
										...
										<td><a href="#APPLICATION.absoluteUrlSite#admin/order_detail.cfm?id=#order.getOrderId()#">View Detail</a></td>
									</tr>
								</cfloop>
							<cfelse>
								<tr>
			...
			<div class="form-group">
				...
				<cfif NOT IsNull(REQUEST.pageData.customer)>
					<a href="#APPLICATION.absoluteUrlSite#admin/new_order.cfm?customer_id=#REQUEST.pageData.customer.getCustomerId()#" class="btn btn-primary top-nav-button">Add Order</a>
					<a href="#APPLICATION.absoluteUrlSite#admin/conversation_detail.cfm?customer_id=#REQUEST.pageData.customer.getCustomerId()#" class="btn btn-primary top-nav-button">Add Conversation</a>
				</cfif>
