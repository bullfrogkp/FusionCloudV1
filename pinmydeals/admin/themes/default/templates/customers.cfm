		...
		<div class="col-xs-12">
			...
			<div class="box box-primary">
				<div class="box-header">
					...
					<a href="#APPLICATION.absoluteUrlSite#admin/customer_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New Customer</a>
				</div><!-- /.box-header -->
						...
						<cfif ArrayLen(REQUEST.pageData.paginationInfo.records) NEQ 0>
							<cfloop array="#REQUEST.pageData.paginationInfo.records#" index="c">
								<tr>
									...
									<td><a href="#APPLICATION.absoluteUrlSite#admin/customer_detail.cfm?id=#c.getCustomerId()#">View Detail</a></td>
								</tr>
							</cfloop>
						<cfelse>
							<tr>
