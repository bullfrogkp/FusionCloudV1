		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					...
					<a href="#APPLICATION.urlAdmin#currency_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add Currency</a>
				</div>
						...
						<cfif ArrayLen(REQUEST.pageData.currencies) NEQ 0>
							<cfloop array="#REQUEST.pageData.currencies#" index="currency">
								<tr>
									...
									<td><a href="#APPLICATION.urlAdmin#currency_detail.cfm?id=#currency.getCurrencyId()#">View Detail</a></td>
								</tr>
							</cfloop>
						<cfelse>
							<tr>
