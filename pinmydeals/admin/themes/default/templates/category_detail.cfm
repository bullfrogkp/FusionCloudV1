...
<input type="hidden" name="tab_id" id="tab-id" value="#REQUEST.pageData.tabs.activeTabId#" />
...
<section class="content">
	<div class="row">
		...
		<div class="col-md-12">
			...
			<div class="form-group">
				<button name="save_item" id="save-item" type="button" class="btn btn-primary top-nav-button">Save Category</button>
