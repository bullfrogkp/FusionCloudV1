				...
				<div class="box-body">
					<ul>
						<cfloop array="#REQUEST.pageData.categoryTree#" index="cat">
							<li><a href="#APPLICATION.urlAdmin#product_detail.cfm?category_id=#cat.getCategoryId()#">#cat.getDisplayName()#</a>
							<cfif ArrayLen(cat.getSubCategories()) NEQ 0>
								<ul>
							</cfif>
							<cfloop array="#cat.getSubCategories()#" index="subCat">
								<li><a href="#APPLICATION.urlAdmin#product_detail.cfm?category_id=#subCat.getCategoryId()#">#subCat.getDisplayName()#</a>
								<cfif ArrayLen(subCat.getSubCategories()) NEQ 0>
									<ul>
								</cfif>
								<cfloop array="#subCat.getSubCategories()#" index="thirdCat">
									<li><a href="#APPLICATION.urlAdmin#product_detail.cfm?category_id=#thirdCat.getCategoryId()#">#thirdCat.getDisplayName()#</a>
								</cfloop>
								<cfif ArrayLen(subCat.getSubCategories()) NEQ 0>
									</ul>
								</cfif>
		...
		<div class="col-md-8">
			...
			<div class="box box-warning">
				<div class="box-header">
					...
					<a href="#APPLICATION.urlAdmin#product_detail.cfm" class="btn btn-default btn-sm pull-right top-nav-anchor">Add New Product</a>
				</div><!-- /.box-header -->
