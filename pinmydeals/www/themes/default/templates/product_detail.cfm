...
<script>
	$(document).ready(function() {
...

		{
			...
			click: function() {
			window.location.href='#APPLICATION.urlAdmin#cart.cfm';
			}
		},
		{
...

		{
			...
			"class": 'checkoutButtonClass',
			click: function() {
			window.location.href='#APPLICATION.urlAdmin#wishlist.cfm';
			}
		},
		{
			text: "Continute Shopping",
			...
			<cfloop query="s">
				{
					...
					selected: false,
					imageSrc: "#APPLICATION.urlAdmin#images/uploads/shipping/#s.image_name#"
				}
